...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Guides = __webpack_require__(10);

	Object.defineProperty(exports, 'Guides', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_Guides).default;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Guides = function (_Component) {
		_inherits(Guides, _Component);

		function Guides(props, context) {
			_classCallCheck(this, Guides);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Guides).call(this, props, context));

			_this.handleTaskSubmit = _this.handleTaskSubmit.bind(_this);
			_this.handleTitleChange = _this.handleTitleChange.bind(_this);
			_this.handleDetailsChange = _this.handleDetailsChange.bind(_this);
			_this.handleGuideSubmit = _this.handleGuideSubmit.bind(_this);
			_this.handleGuideChange = _this.handleGuideChange.bind(_this);
			return _this;
		}
		...
		_createClass(Guides, [{
			...
			value: function handleTaskSubmit(e) {
				e.preventDefault();
				this.props.handleTS(this.props.task_title.trim(), this.props.task_details.trim());
			}
			...
			value: function handleDetailsChange(e) {
			...
			key: "handleGuideSubmit",
			value: function handleGuideSubmit(e) {
				e.preventDefault();
			...
			key: "handleGuideChange",
			value: function handleGuideChange(e) {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement("p", { className: "box",
						dangerouslySetInnerHTML: { __html: outputTasks(this.props.tasks) } }),
					_react2.default.createElement(
						"form",
						{ onSubmit: this.handleGuideSubmit },
						_react2.default.createElement(
							"div",
							null,
							"Guide Title: "
						...
						_react2.default.createElement("br", null),
						_react2.default.createElement("br", null),
						_react2.default.createElement("input", { type: "submit", value: "Submit Guide" })
					),
					_react2.default.createElement("br", null),
					_react2.default.createElement("br", null)
				);
	...
	Guides.propTypes = {
		task_title: _react.PropTypes.string.isRequired,
		task_details: _react.PropTypes.string.isRequired,
		tasks: _react.PropTypes.array.isRequired,

		title_submit: _react.PropTypes.string.isRequired,
		details_submit: _react.PropTypes.string.isRequired,

		guide_title: _react.PropTypes.string.isRequired,
		guide_submit: _react.PropTypes.string.isRequired,
		guides: _react.PropTypes.array.isRequired,

		handleTS: _react.PropTypes.func.isRequired, //task submit
		handleGS: _react.PropTypes.func.isRequired, //guide submit

		handleTC: _react.PropTypes.func.isRequired, //task title change
		handleDC: _react.PropTypes.func.isRequired, //task details change
		handleGC: _react.PropTypes.func.isRequired };
	Guides.defaultProps = {};
